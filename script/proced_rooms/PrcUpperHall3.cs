...
public partial class PrcUpperHall3 : Node2D
{
    ...
    public override async void _Ready()
    {
        ...
        exit1_common = new Godot.Collections.Array{"prc_right_hall_0", "prc_right_hall_1", "prc_right_hall_2", "prc_right_end"}; //RIGHT
    ...
    public void room_generate()
    {
        ...
        } else
        {
            ...
            packedScene = (PackedScene)GD.Load("res://proced_rooms/prc_right_end.tscn");
            s = (Node2D)packedScene.Instantiate();
            s.Position = Exit1.Position;
            AddChild(s);
        }
