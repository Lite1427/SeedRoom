...
public partial class PrcDownHall1 : Node2D
{
    ...
    public override async void _Ready()
    {
        ...
        exit1_common = new Godot.Collections.Array{"prc_left_end"}; // LEFT
    ...
    public void room_generate()
    {
        ...
        } else if (GlobalVariables.rooms_to_create < rooms_to_create)
        {
