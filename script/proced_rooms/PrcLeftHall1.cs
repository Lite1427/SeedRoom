...
public partial class PrcLeftHall1 : Node2D
{
    ...
    public override async void _Ready()
    {
        ...
        exit0_common = new Godot.Collections.Array{"prc_down_hall_0", "prc_down_hall_1", "prc_down_end"}; // DOWN
    ...
    public void room_generate()
    {
        ...
        {
            PackedScene packedScene = (PackedScene)GD.Load("res://proced_rooms/prc_down_end.tscn");
            Node2D s = (Node2D)packedScene.Instantiate();
            s.Position = Exit0.Position;
            AddChild(s);
        }
