...
public partial class PrcUpperHall2 : Node2D
{
    ...
    public override async void _Ready()
    {
        ...
        exit1_common = new Godot.Collections.Array{"prc_right_hall_0", "prc_right_hall_1", "prc_right_hall_2", "prc_right_end"}; // LEFT
